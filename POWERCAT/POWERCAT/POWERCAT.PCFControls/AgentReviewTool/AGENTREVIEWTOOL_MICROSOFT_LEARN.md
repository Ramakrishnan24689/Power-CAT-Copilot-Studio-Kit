# Agent Review Tool for Copilot Studio (Preview)
...
5. **Power Apps Component Framework (PCF) support enabled**

6. **Agent development permissions in Copilot Studio**

7. **Copilot Studio agent configured with Generative AI Orchestration**
