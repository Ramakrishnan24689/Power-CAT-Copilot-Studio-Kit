...
import { FileExportControl } from "./FileExportControl";
import * as React from "react";

export class FileExport implements ComponentFramework.ReactControl<IInputs, IOutputs> {
    ...
    private _onExportResult = (status: "success" | "error", message: string): void => {
        this._exportStatus = status;
    ...
    public getOutputs(): IOutputs {
        return {
            ...
            exportMessage: this._exportMessage,
        };
    }
